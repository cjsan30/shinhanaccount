...
type Props = { ledger: Ledger; policyBook: PolicyBook; merchantRules: MerchantRule[]; onRestore: (payload: BackupPayload) => void; notify: (message: string) => void; embedded?: boolean };

export function BackupRestore({ ledger, policyBook, merchantRules, onRestore, notify, embedded = false }: Props) {
