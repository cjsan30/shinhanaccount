...
const { smsBridge, notificationBridge } = vi.hoisted(() => ({ smsBridge: { configure: vi.fn(), syncBudgetState: vi.fn(), injectTestApproval: vi.fn(), scheduleTestApproval: vi.fn(), requestPermission: vi.fn(), consumePendingApprovals: vi.fn() }, notificationBridge: { requestPermission: vi.fn(), show: vi.fn() } }));
...
beforeEach(() => {
  ...
  smsBridge.injectTestApproval.mockResolvedValue(undefined);
  smsBridge.scheduleTestApproval.mockResolvedValue(undefined);
