...
function App() {
  ...
  const previewImportFile = async () => {
    ...
    try {
      ...
      show(`${transactions.length}건의 ${isPdf ? '은행 PDF' : '카드 엑셀'} 내역을 확인했습니다.`);
    } catch (error) {
