...
internal object SmsDiagnosticStage {
    ...
    const val NOTIFICATION_SOURCE_UNSUPPORTED = "NOTIFICATION_SOURCE_UNSUPPORTED"
    const val NOTIFICATION_GROUP_SUMMARY_SKIPPED = "NOTIFICATION_GROUP_SUMMARY_SKIPPED"
}
